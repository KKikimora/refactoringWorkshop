...
void Controller::receive(std::unique_ptr<Event> e)
{
    ...
    {
        case TimeoutInd::MESSAGE_ID: if(!is_pause) return handleTimePassed(*static_cast<EventT<TimeoutInd> const&>(*e)); break;
        case DirectionInd::MESSAGE_ID: if(!is_pause) return handleDirectionChange(*static_cast<EventT<DirectionInd> const&>(*e)); else break;
